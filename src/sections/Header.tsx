        ...
        <div className="container !max-w-full">
          <div className="flex justify-end h-20 items-center">
            <div className="flex items-center gap-4">
              ...
              {/* Book Now Button with AlertDialog */}
              <AlertDialog>
                <AlertDialogTrigger asChild>
                  <button className="bg-golf-green h-11 px-6 rounded-xl text-white border border-golf-green uppercase hidden md:inline-flex items-center">
                    Book Now
                  </button>
                </AlertDialogTrigger>
                <AlertDialogContent>
                  ...
                  <div className="flex justify-end mt-4">
                    <AlertDialogCancel className="bg-gray-200 px-4 py-2 rounded text-black">Close</AlertDialogCancel>
                  </div>
                </AlertDialogContent>
              </AlertDialog>
            </div>
